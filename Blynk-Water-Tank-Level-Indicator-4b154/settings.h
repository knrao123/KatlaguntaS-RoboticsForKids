...
#define FULLTANK 2000  //in liters                         
#define MINIMUMRANGE 20 // sensor needs minimum 20 cm distance to work


#define WATER_TANK_LENGTH_IN_CM 115 // Water tank lenght in cm
#define WATER_TANK_WIDTH_IN_CM 115 // water tank width in cm
...
#define WATER_TANK_HEIGHT_IN_CM 165 // 274cm is after reducing 20cm + 5.08cm +10cm height from original tank height to work sensor
